...
public class MoviesActivity extends AppCompatActivity {
    ...
    public void end_Test(View view) {
        EditText nameField = (EditText) findViewById(R.id.name_field_movies);
        ...
        Button endTestButton = (Button) findViewById(R.id.end_test_button_movies);
    ...
    private void displayResult(String result) {
        TextView testResultTextView = (TextView) findViewById(R.id.test_result_text_view_movies);
