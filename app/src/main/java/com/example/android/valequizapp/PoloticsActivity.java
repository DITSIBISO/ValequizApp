...
public class PoloticsActivity extends AppCompatActivity {
    @Nullable
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polotics);
    ...
    public void end_Test(View view) {
        EditText nameField = (EditText) findViewById(R.id.name_field_Polotics);
        ...
        Button endTestButton = (Button) findViewById(R.id.end_test_button_polotics);
    ...
    public void question_1() {
        ...
        CheckBox AvailabilityyCheckBox = (CheckBox) findViewById(R.id.availabilityy_checkbox);
        boolean hasAvailabilityy = AvailabilityyCheckBox.isChecked();
        ...
        CheckBox IntegrityyCheckBox = (CheckBox) findViewById(R.id.integrityy_checkbox);
        boolean hasIntegrityy = IntegrityyCheckBox.isChecked();
        ...
        CheckBox ConfidentialityyCheckBox = (CheckBox) findViewById(R.id.confidentialityy_checkbox);
        boolean hasConfidentialityy = ConfidentialityyCheckBox.isChecked();

        if (hasConfidentialityy) {
            increment_score();
        }
    }
    ...
    public void question_2() {
        ...
        switch (answers.getCheckedRadioButtonId()) {
            case R.id.answer_2_3_3radiobutton:
                answerRadio = (RadioButton) findViewById(R.id.answer_2_1_1radiobutton);
                increment_score();
                break;
            default:
                answerRadio = (RadioButton) findViewById(R.id.answer_2_2_2radiobutton);
                answerRadio = (RadioButton) findViewById(R.id.answer_2_3_3radiobutton);
                answerRadio = (RadioButton) findViewById(R.id.answer_2_4_4radiobutton);
        }
    }
    ...
    public void question_3() {
        ...
        switch (answers.getCheckedRadioButtonId()) {
            case R.id.tech3_radiobutton:
                answerRadio = (RadioButton) findViewById(R.id.tech_radiobutton);
                increment_score();
                break;
            default:
                answerRadio = (RadioButton) findViewById(R.id.tech1_radiobutton);
                answerRadio = (RadioButton) findViewById(R.id.tech2_radiobutton);
                answerRadio = (RadioButton) findViewById(R.id.tech3_radiobutton);
                answerRadio = (RadioButton) findViewById(R.id.tech4_radiobutton);
        }
    }
    ...
    public void question_4() {
        ...
        CheckBox PhysicalCheckBox = (CheckBox) findViewById(R.id.redundancy11_checkbox);
        ...
        CheckBox LogicalCheckBox = (CheckBox) findViewById(R.id.redundancy22_checkbox);
        ...
        CheckBox AdministrativeCheckBox = (CheckBox) findViewById(R.id.redundancy33_checkbox);
    ...
    public void question_5() {
        ...
        CheckBox Answer_5_1_1_1CheckBox = (CheckBox) findViewById(R.id.answer_5_1_1_1_1checkbox);
        boolean hasAnswer_5_1_1_1CheckBox = Answer_5_1_1_1CheckBox.isChecked();

        if (hasAnswer_5_1_1_1CheckBox) {
            increment_score();
        }

        // Figure out if the user chose "DAI can prevent common man-in-the-middle (MIM) attacks such as ARP cache poisoning" answer
        CheckBox Answer_5_2_2_1_1CheckBox = (CheckBox) findViewById(R.id.answer_5_2_2_1_1checkbox);
        boolean hasAnswer_5_2_2_1_1_CheckBox = Answer_5_2_2_1_1CheckBox.isChecked();

        if (hasAnswer_5_2_2_1_1_CheckBox) {
            increment_score();
        }

        // Figure out if the user chose "Prevents mis-configuration of client IP addresses" answer
        CheckBox Answer_5_4_4_4_1CheckBox = (CheckBox) findViewById(R.id.answer_5_4_4_4_1checkbox);
        boolean hasAnswer_5_4_4_4_1CheckBox = Answer_5_4_4_4_1CheckBox.isChecked();

        if (hasAnswer_5_4_4_4_1CheckBox) {
            increment_score();
        }
    }
    ...
    private void displayResult(String result) {
        TextView testResultTextView = (TextView) findViewById(R.id.test_result_text_view_polotics);
